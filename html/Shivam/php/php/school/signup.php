...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(!empty($_POST['first'])){
            ...
            if(!empty($_POST['last'])){
                if(ctype_alpha($_POST['last'] )&& strlen($_POST['last'])<=30){
                    ...
                    if(!empty($_POST['username'])){
                        if(ctype_alnum($_POST['username'])  || ctype_alpha($_POST['usrename'])){
                        ...
                        echo'
                        <script>
                        alert("Username Name Should Not Be Entered");
                        </script>';
                    }
                }
                else{
                ...
                echo'
                <script>
                alert("Last Name Should Not Be Entered");
                </script>';
            }
        }
        else{
        ...
        echo '
        <script>
        alert("First Name Should Not Be Entered");
        </script>';
    }
}
...
if($num==1){
    ...
    if($data['username']==$username ){
      ...
      if($user_query && $otp_query && sendmail($email,"OTP Verification",$otp,"verify")){
        ...
        echo'
        <script>
        alert("Regstration not Successful");
    </script>
    ';
      }
}
