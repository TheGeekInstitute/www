...
<body>
    ...
    <div class="container">
        ...
        <div class="link">
            <p>Generated Link : ↓</p> <a href="payment.php?payment_id=<?php echo $_SESSION['payment_id'] ?>">https://<?php echo $_SERVER['HTTP_HOST'];  ?>/payment.php?payment_id=<?php echo $_SESSION['payment_id'] ?></a>
        </div>
