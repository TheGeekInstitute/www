                                ...
                                if(in_array($ext,$ext_lst)){
                                    if($size<=2){
                                        if(move_uploaded_file($tmp,$dest)){
                                            ...
                                            $sql="SELECT `fullname`, `email`, `phone`, `username`, `password` FROM `users` WHERE `email`='$email' OR `phone`='$phone' OR `username`='$username'";
                                            ...
                                            if($query){
                                                if(mysqli_num_rows($query)==1){
                                                    ...
                                                    $sql="INSERT INTO `users`(`fullname`, `email`, `phone`, `username`, `password`,`photo`) VALUES('$name','$email','$phone','$username','$password','$dest')";
                                                        $query=mysqli_query($conn,$sql);
                                                        if($query){
...
<body>
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="or">
          ...
          <div class="log">
            <p>Already a user?</p>
            <a href="http://10.10.10.10/Nikhil/chat/login.php">LOGIN</a>
          </div>
           </div>
