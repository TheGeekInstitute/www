...
if($_SERVER['REQUEST_METHOD']== "POST"){
    if(isset($_POST ['username']) && !empty($_POST['username'])){
        ...
        if(isset($_POST['password']) && !empty($_POST['password'])){
            ...
            $sql="SELECT `fullname`, `email`, `phone`, `username`, `password` , `photo` FROM `users` WHERE `username`='$username' OR `email`='$username' OR `phone`='$username'";
...
<body>
    <form method="post">
        ...
        <div class="or">
          ...
          <div class="log">
            <p>Already a user?</p>
            <a href="http://10.10.10.10/Nikhil/chat/signup.php">SIGNUP</a>
          </div>
           </div>
