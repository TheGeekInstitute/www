...
$first=$last=$gender=$class=$roll_no="";
                ...
                if(!empty($_POST['class']) && $_POST['class']!="Choose"){
                     $class=$_POST['class'];
                        ...
                        // }
                            ...
                            $sql="INSERT INTO `students`(`firstname`, `lastname`, `gender`, `class`,`photo`) VALUES ('$first','$last','$gender','$class','$dest')";
                        ...
                        if(isset($_POST['update']) && !empty($_POST['roll_no']) && ctype_digit($_POST['roll_no'])){
                            $sql="UPDATE `students` SET `firstname`='$first',`lastname`='$last',`gender`='$gender',`class`='$class' WHERE `roll_no`='$_POST[roll_no]'";
                            $query=mysqli_query($connection,$sql);
                            if($query){
                                echo ' 
                                <script>
