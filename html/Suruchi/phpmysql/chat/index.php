        ...
        if(isset($_POST['username']) && !empty($_POST['username'])){
            ...
            if(isset($_POST['email']) && !empty($_POST['email'])){
                ...
                if(isset($_POST['Pasword']) && !empty($_POST['Pasword'])){
                    $Pasword=Pasword_hash($_POST['Pasword'],PASSWORD_BCRYPT);
                    ...
                    if($query){
                        ...
                        if(mysqli_num_rows($query)>0){
                            ...
                            if($data['username']==$username){
                                $smg="username Already Taken";
                            }
                            else{
                                $smg="Email Already Registered";
                            }
                        }
                        else{
                            // INSERT
                            ...
                            if($query){
                                ...
                                $smg="Registration Successfully";
                            }
                            else{
                                $smg="Can not Register At This Time <br> Server Busy";
                            }
                        }
                    }
                    else{
                    ...
                    $smg="Please Enter Pasword";
                }
            }
            else{
                $smg="Please Enter Email";
            }
        }
        else{
            $smg="Please Enter Username";
        }
    }
    else{
